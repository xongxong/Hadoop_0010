...
public class Subscriber implements TibrvMsgCallback {
    ...
    public void onMsg(TibrvListener listener, TibrvMsg msg) {
        try {
            ...
            System.out.println("Received KEY:" + msg.get("KEY"));
            System.out.println("Received VALUE:" + msg.get("VALUE"));
            System.out.flush();

            TibrvRvdTransport transport = new TibrvRvdTransport("7522", null,"192.168.99.62:7500");
            TibrvMsg newmsg = new TibrvMsg();
            newmsg.setSendSubject("FDC_SUBJECT");
